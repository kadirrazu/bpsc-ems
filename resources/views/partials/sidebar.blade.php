...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="alerts.html">Board Assignment</a>
    ...
    <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Task Panel</h6>
        <a class="collapse-item" href="alerts.html">Add a User</a>
        <a class="collapse-item" href="buttons.html">Users List</a>
        <a class="collapse-item" href="buttons.html">Import Board Candidates</a>
        </div>
    </div>
    </li>
    <hr class="sidebar-divider">
